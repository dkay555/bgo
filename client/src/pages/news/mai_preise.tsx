...
export default function MaiPreiseAngebot() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6 md:py-10" id="top">
      <Helmet>
        <title>Neue Preise & Accountsicherheit | babixGO</title>
        <meta name="description" content="Die neusten Informationen zu unseren Preisen für Würfel-Boosts und wichtige Hinweise zur Accountsicherheit." />
      </Helmet>
