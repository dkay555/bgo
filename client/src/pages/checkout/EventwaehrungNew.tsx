                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        <p className="text-sm text-gray-600">
                          Wir benötigen deinen Facebook Auth-Token, um Eventwährung in dein Spiel übertragen zu können. 
                          Keine Sorge, dies wird nur verwendet, um die Währung zu übertragen.
                        </p>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        <p className="text-sm text-gray-600">
                          ...
                          um Eventwährung in dein Spiel übertragen zu können.
                        </p>
                      </div>
