  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col items-center mb-8">
        ...
        <h1 className="babix-info-header text-3xl md:text-4xl font-bold mb-8 text-center">Race Events - Hilfe & Informationen</h1>
      </div>
      
      <div className="max-w-3xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <h2 className="text-2xl font-bold text-[#0A3A68] mb-6">Hilfe zu Race Events</h2>
          <p className="mb-6">
            Dieser Bereich wird in Kürze mit detaillierten Hilfe-Informationen zu Race Events gefüllt.
          </p>
          
          <div className="bg-[#E6F7FF] border-l-4 border-[#00CFFF] p-4 rounded-r-md">
            <h4 className="font-bold text-[#0A3A68] mb-2">Race-Plätze kaufen</h4>
